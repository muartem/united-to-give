...
const GroupDonation = () => {
	...
	return (
		...
		>
			...
			>
				<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, facilis, quaerat? Doloribus et eveniet iure laudantium, magni provident repellat tenetur.</div>
				<JoinDonationForm />
			</div>
		</section>
	)
