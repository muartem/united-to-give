...
const MainHero = () => {
	return (
		<div className="w-dvw bg-main-gradient text-light-black mb-10 px-28">
			<div className="relative max-w-screen-xl m-auto h-full flex justify-between items-stretch text-center md:text-left">
				<div className="flex flex-col w-[50%] justify-between py-16">
					<div>
				...
				<div className="w-[50%] relative">
					...
					<div className="flex flex-col p-16 relative z-10">
						...
						<div className="text-lg font-normal leading-[140%] text-white mb-[107px] w-[100%]">
