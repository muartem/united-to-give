...
const NotFound = () => {
  return (
    <div className="flex flex-col gap-4 text-center items-center p-12 justify-center h-dvh w-full">
      ...
      <Link href={'/en'} className="b2 text-primary font-bold flex justify-center items-center gap-4 hover:text-dark-primary p-2">
          Go to home
